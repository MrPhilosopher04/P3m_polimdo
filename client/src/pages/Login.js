  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-100 p-4">
      <div className="w-full max-w-6xl flex flex-col md:flex-row bg-white rounded-3xl shadow-2xl overflow-hidden">
        {/* Ilustrasi Panel */}
        <div className="w-full md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-800 p-8 md:p-12 text-white hidden md:flex flex-col justify-between">
          <motion.div 
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold">P3M Polimdo</h1>
            <p className="text-blue-100 mt-2">Sistem Penelitian, Pengabdian & Publikasi</p>
          </motion.div>
          ...
          >
            <div className="flex items-center mb-4">
              <div className="mr-3 w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Data Anda dilindungi dengan enkripsi mutakhir</p>
              </div>
            </div>
            
            <div className="flex items-center">
              <div className="mr-3 w-10 h-10 rounded-full bg-indigo-500 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Proses penelitian lebih efisien dan terintegrasi</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-12">
          ...
          >
            ...
            <p className="text-gray-600 mt-2">
              Silakan masuk untuk melanjutkan ke sistem P3M Polimdo
            </p>
          </motion.div>
